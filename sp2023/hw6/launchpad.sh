...
srun python classification.py  --experiment "overfit" --device cuda --model "distilbert-base-uncased" --batch_size "64" --lr 1e-4 --num_epochs 7
...
srun python classification.py  --experiment "overfit" --device cuda --model "distilbert-base-uncased" --batch_size "64" --lr 5e-4 --num_epochs 5
...
srun python classification.py  --experiment "overfit" --device cuda --model "distilbert-base-uncased" --batch_size "64" --lr 1e-3 --num_epochs 5

srun python classification.py  --experiment "overfit" --device cuda --model "distilbert-base-uncased" --batch_size "64" --lr 1e-3 --num_epochs 7